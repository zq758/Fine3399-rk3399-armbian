...
但经测试，xiayang0521的早期armbain固件提取出来的uboot引导分区镜像（https://github.com/QXY716/u-boot/blob/main/u-boot/rockchip/fine3399/uboot-bozz-rk3399.bin），缝合进ophub大佬的固件之后，均能正常启动，内核5.15,6.1,6.6都通过。  
